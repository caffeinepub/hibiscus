...
export class Backend implements backendInterface {
    ...
    async addEntry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addEntry(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async archiveDay(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.archiveDay(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllEntryDates(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllEntryDates();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getArchivedDaysWithinYear(): Promise<Array<ArchivedDay>> {
        if (this.processError) {
            try {
                const result = await this.actor.getArchivedDaysWithinYear();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEntriesForDate(arg0: string): Promise<Array<TimetableEntry>> {
        if (this.processError) {
            try {
    ...
    async unarchiveDay(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.unarchiveDay(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateEntry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: string): Promise<void> {
        if (this.processError) {
            try {
